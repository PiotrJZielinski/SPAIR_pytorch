...
from spair.dataloader import CityscapesNoTarget
...
def main():
    ...
    data = CityscapesNoTarget("data/cityscapes", split="train_extra", transform=Resize((128, 128)))

    run_manager = RunManager(run_name=run_name, dataset=data, device=device,
                             writer=writer, run_args=args)
